...
const renderComponent = (playerSeasonStats: PlayerSeasonStat[], routerService?: RouterService) => {
  ...
  return render(PlayerSeasonStatsComponent, { inputs: { playerSeasonStats }, providers });
};
...
describe('PlayerSeasonStatsComponent with dummy team', () => {
  it('does not render team name when team is dummy', async () => {
    const stat = fakePlayerSeasonStat();
    stat.team.dummy = true;
...
describe('PlayerSeasonStatsComponent with single stat', () => {
...
describe('PlayerSeasonStatsComponent summary', () => {
...
describe('PlayerSeasonStatsComponent with no stats', () => {
  beforeEach(async () => {
...
describe('PlayerSeasonStatsComponent navigation', () => {
