...
@Component({
  ...
  imports: [D11MatchResultColComponent, SafeDatePipe, TitleCasePipe, ProgressSpinner],
  templateUrl: './match-week-d11-matches.component.html',
  host: { class: 'min-h-157' },
})
export class MatchWeekD11MatchesComponent {
  ...
  protected isLoading = computed(() => this.rxMatches.isLoading());
