...
import { D11TeamSeasonStatsComponent } from './d11-team-season-stats.component';

const mockRouterService = { navigateToD11Team: vi.fn() };

describe('D11TeamSeasonStatsComponent', () => {
  let fixture: ComponentFixture<D11TeamSeasonStatsComponent>;

  async function setup(d11TeamSeasonStats: D11TeamSeasonStat[]) {
    fixture = TestBed.createComponent(D11TeamSeasonStatsComponent);
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [D11TeamSeasonStatsComponent],
