...
describe('PlayerMatchStatsAccordionComponent', () => {
  ...
  it('does not render Substitutes header in d11-match context', async () => {
    ...
    await render(PlayerMatchStatsAccordionComponent, {
      inputs: { context: 'd11-match', playerMatchStats: stats },
      providers: [provideRouter([])],
    });
  ...
  it('shows "Did not participate" in accordion content for DNP player', async () => {
    await render(PlayerMatchStatsAccordionComponent, {
      inputs: { context: 'match', playerMatchStats: [didNotParticipate()] },
      providers: [provideRouter([])],
    });
  ...
  it('shows "Unused substitute" in accordion content for unused sub', async () => {
    await render(PlayerMatchStatsAccordionComponent, {
      inputs: { context: 'match', playerMatchStats: [unusedSub()] },
      providers: [provideRouter([])],
    });
  ...
  it('shows goals in accordion content', async () => {
  ...
  it('shows assists in accordion content', async () => {
  ...
  it('shows own goals in accordion content', async () => {
