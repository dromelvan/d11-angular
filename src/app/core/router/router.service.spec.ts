...
describe('RouterService', () => {
  ...
  it('navigates to match with matchBase passes it in navigation state', async () => {
    const matchId = 1;
    const matchBase = fakeMatchBase();
    await service.navigateToMatch(matchId, true, matchBase);
  ...
  it('navigates to edit player', async () => {
    ...
    expect(mockRouter.navigate).toHaveBeenCalledWith(['players', playerId, 'edit']);
    expect(result).toBe(true);
  });
      ...
      TestBed.configureTestingModule({
        providers: [
          ...
          provideRouter([
            ...
            { path: 'players/:id/edit', component: BlankComponent },
