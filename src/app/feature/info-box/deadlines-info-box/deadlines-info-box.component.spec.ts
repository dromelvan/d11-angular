...
const template = `<app-deadlines-info-box [transferWindow]="transferWindow" />`;
  ...
  describe('with transfer window', () => {
    ...
    beforeEach(async () => {
      ...
      await render(template, {
        imports: [DeadlinesInfoBoxComponent],
        componentProperties: { transferWindow },
      });
    });

    it('renders', () => {
      expect(document.querySelector('app-deadlines-info-box')).toBeInTheDocument();
    });
