...
@Component({
  selector: 'app-players-season-stats',
  imports: [
    Drawer,
    FormsModule,
    Paginator,
  ...
  templateUrl: './players-season-stats.component.html',
})
export class PlayersSeasonStatsComponent {
  ...
  protected isLoading = computed(() => this.rxPlayerSeasonStats.isLoading());
