...
@Component({
  selector: 'app-transfer-day-transfer-listings',
  imports: [TeamImgComponent, D11TeamImgComponent],
  templateUrl: './transfer-day-transfer-listings.component.html',
})
export class TransferDayTransferListingsComponent {
