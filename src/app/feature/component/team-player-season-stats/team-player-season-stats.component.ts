...
@Component({
  selector: 'app-team-player-season-stats',
  imports: [D11TeamImgComponent, TeamImgComponent, PlayerImgComponent, RatingPipe, FeePipe],
  templateUrl: './team-player-season-stats.component.html',
})
